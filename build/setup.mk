...
# Gather build variables to inject into the manifest tool. Fall back to
# "unknown" when git is unavailable (e.g. a tarball build or a bare-repo
# worktree copied into a CI container) so the resulting version string
# remains valid semver metadata.
